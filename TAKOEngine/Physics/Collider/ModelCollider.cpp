...
ModelCollider::ModelCollider(iModel* _model, uint16_t _objType, DirectX::XMFLOAT4X4* _transform) : Collider(_objType, _transform)
{
	model = _model;
	m_shapeType = COLLIDER_TYPE::MODEL;
}
