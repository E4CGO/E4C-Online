//! @file LuminanceExtractionShader.cpp
//! @note 
...
// @return    なし
//**********************************************************************
LuminanceExtractionShaderDX12::LuminanceExtractionShaderDX12(ID3D12Device* device)
{
	...
	{
		GpuResourceUtils::LoadShaderFile("Data/Shader/LuminanceExtractionDX12VS.cso", vsData);
		GpuResourceUtils::LoadShaderFile("Data/Shader/LuminanceExtractionDX12PS.cso", psData);
	}
	...
	// ルートシグネクチャの生成
	{
		...
		m_d3d_root_signature->SetName(L"LuminanceExtractionSpriteShaderRootSignature");
	}
	...
	// パイプラインステートの生成
	{
		...
		_ASSERT_EXPR(SUCCEEDED(hr), HRTrace(hr));
		m_d3d_pipeline_state->SetName(L"LuminanceExtractionSpriteShaderPipelineState");
	}
}
...
// @return      なし
//***********************************************************
void LuminanceExtractionShaderDX12::Render(const RenderContextDX12& rc, SpriteDX12* sprite)
{
	Graphics& graphics = Graphics::Instance();
