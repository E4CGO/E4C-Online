...
class CombinedPlayer : public Character
{
public:
	...
	static DirectX::XMFLOAT4 GetColorSet(int idx) { return CombinedPlayer::colorSet[idx]; }
protected:
...
protected:
	...
	std::vector<std::unique_ptr<ModelObject>> m_CharacterParts;
};
